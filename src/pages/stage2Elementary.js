				...
				>
					...
					>
						<Box
							...
							lg-padding="36px 36px 36px 36px"
							lg-border-radius="30px"
							lg-background="#ffffff"
							lg-border-color="rgba(190, 190, 190, 0.65)"
							lg-border-width="2px"
							lg-border-style="solid"
							lg-width="100%"
							lg-height="320px"
							lg-hover-box-shadow="7px 10px 10px 2px --color-grey"
							lg-hover-transform="translateY(-10px)"
							lg-hover-filter="grayscale(5%)"
						>
							<Icon
								category="fa"
								icon={FaTree}
